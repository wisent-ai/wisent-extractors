...
__all__ = ["MultipleCppExtractor"]

log = setup_logger(__name__)


class MultipleCppExtractor(HuggingFaceBenchmarkExtractor):
    """
    ...
    def extract_contrastive_pairs(
        ...
        log.info(f"Extracting contrastive pairs from {len(docs)} multiple_cpp examples")
        ...
        if not pairs:
            log.warning("No valid multiple_cpp pairs extracted")
