...
__all__ = ["MultipleGoExtractor"]

log = setup_logger(__name__)


class MultipleGoExtractor(HuggingFaceBenchmarkExtractor):
    """
    ...
    def extract_contrastive_pairs(
        ...
        log.info(f"Extracting contrastive pairs from {len(docs)} multiple_go examples")
        ...
        if not pairs:
            log.warning("No valid multiple_go pairs extracted")
