...
__all__ = ["MultipleJsExtractor"]

log = setup_logger(__name__)


class MultipleJsExtractor(HuggingFaceBenchmarkExtractor):
    """
    ...
    def extract_contrastive_pairs(
        ...
        log.info(f"Extracting contrastive pairs from {len(docs)} multiple_js examples")
        ...
        if not pairs:
            log.warning("No valid multiple_js pairs extracted")
