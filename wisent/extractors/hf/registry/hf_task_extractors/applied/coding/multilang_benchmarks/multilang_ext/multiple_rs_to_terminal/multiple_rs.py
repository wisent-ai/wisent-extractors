...
__all__ = ["MultipleRsExtractor"]

log = setup_logger(__name__)


class MultipleRsExtractor(HuggingFaceBenchmarkExtractor):
    """
    ...
    def extract_contrastive_pairs(
        ...
        log.info(f"Extracting contrastive pairs from {len(docs)} multiple_rs examples")
        ...
        if not pairs:
            log.warning("No valid multiple_rs pairs extracted")
